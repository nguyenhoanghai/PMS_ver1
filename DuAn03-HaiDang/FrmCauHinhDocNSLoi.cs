...
{
    public partial class FrmCauHinhDocNSLoi : Form
    {
        ...
        private void FrmCauHinhDocNSLoi_Load(object sender, EventArgs e)
        {
            try
            {
                CreateGirdView();
            ...
            try
            {
                ...
                switch (columnName)
                {
                    ...
                    case "CauHinhDocAmThanh":
                        {
                            FrmCauHinhDocAmThanh form = new FrmCauHinhDocAmThanh(idChuyen, tenChuyen, 2);
        ...
        private void LoadDataGridView()
        {
            try
            {
                soundTimeConfig.LoadMailToDataGirdview(dgListTime, 2);
            }
            catch (Exception ex)
            {                
                throw ex;
